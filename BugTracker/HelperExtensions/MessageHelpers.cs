...
namespace BugTracker.HelperExtensions
{
    public static class MessageHelpers
    {
        ...
        public static IdentityMessage CreateTicketModifiedMessage(this Ticket ticket, ApplicationUser user)
        {
            ...
            var msg = new IdentityMessage();
            msg.Destination = user.Email;
            msg.Body = "The ticket " + ticket.Name + " in project " + project.Name + " has been modified. Please review the changelog to see if any action is necessary. View the ChangeLog <a href=\"https://awest-bugtracker.azurewebsites.net/Tickets/Details/" + ticket.Id + "\">here.</a>";
